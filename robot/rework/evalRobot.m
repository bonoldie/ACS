function [evalStructure, torques] = evalRobot(roboticStructure, jointValues)
    ...
    evalStructure.dynamics.C = subs(evalStructure.dynamics.B, evalStructure.jointsSymbol(:), jointValues(:));
    evalStructure.dynamics.G = subs(evalStructure.dynamics.B, evalStructure.jointsSymbol(:), jointValues(:));
